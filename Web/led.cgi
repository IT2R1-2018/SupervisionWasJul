...
t           							"#003366">Pilotage des LED du MCB1768</font></b></h2>
t 										<p align="center"><img border="0" height="140" width="150"
t                         				src="Logo_GEii2.png"></a></p>
t 										<p><font size="2">Cette page permet de piloter les 8 LED présentes 
t 										sur la carte Keil</font></p>
t
t 										<form action=led.cgi method=post name=cgi>
...
c d 0 <td><input type=checkbox name=led0 value=1 %s>LED0</td>
t 														</tr>
t 													</font></table>
t 													</td>
t 												</tr>
...
t 										<p align=center>
t 											<input type=submit name=set_led value="Envoyer" id="sbm2">
t 										</p>
t 										</form>
t 									</td>					
t      							</tr>
